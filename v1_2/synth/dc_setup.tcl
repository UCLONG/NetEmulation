...
# topographical mode illiminates the need for wire-load models
# (uses physical ests. of place&routed design during synthesis)
...
#set RTL_SOURCE_FILES  "ppe.sv arbiter.sv"      ;
