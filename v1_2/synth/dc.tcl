...
# Don't have the license required by the -spg option?
...
# Write out Design
#
# Note: For a flow with physical guidance, you must use a binary design format
#       (.ddc or Milkyway) when passing the design to IC Compiler.
#################################################################################
